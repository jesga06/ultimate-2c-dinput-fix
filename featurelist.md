...
* **Interactive Chords & Hardware Chords Tutorial:** Prominent tutorial banner card and interactive modal guide (`open_chords_guide_modal`) providing step-by-step tutorials, execution modes, and architectural comparisons between Hardware Chords (upstream input suppression) and Standard Chords & Macros.
