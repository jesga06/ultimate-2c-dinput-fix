...
- **Chords & Hardware Chords Master Tutorial & Ghost Placeholder Text:** Refined the Advanced Tab tutorial card and interactive modal guide (`open_chords_guide_modal`) to feature clear, jargon-free descriptions, exact matching GUI field names (`Chord:`, `Action:`, `Delayed:`, `Mode:`, `Inputs:`, `Outputs:`), clean ASCII formatting without emojis, and added native gray ghost placeholder template text to all Chords and Hardware Chords entry fields.
