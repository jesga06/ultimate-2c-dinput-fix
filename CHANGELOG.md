...
- **Chords & Hardware Chords Master Tutorial & Info Box:** Refined the Advanced Tab tutorial card and interactive modal guide (`open_chords_guide_modal`) to feature clear, jargon-free descriptions, exact matching GUI field names (`Chord:`, `Action:`, `Delayed:`, `Mode:`, `Inputs:`, `Outputs:`), and clean ASCII formatting without emojis.
